...
### 2.SSD1306のライブラリ活用
* **課題:** 
最初は、SSD1306の初期設定をいろいろなコードを参考にして、自分で作ろうとしました。しかし、設定する項目が多く、それぞれが何を意味しているのか分からない部分がありました。<br>

* **解決策:** 
そこで、GitHubでSSD1306に対応したMIT Licenseのオープンソースライブラリを見つけ、導入しました。<br>
ライブラリのファイルをプロジェクトに追加し、メインコードから読み込むことで、SSD1306の設定を簡単にできるようになりました。<br>
