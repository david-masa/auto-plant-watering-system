...
左ボタン押下時：現在の土壌湿度レベルを測定し、モニタに（SUPER DRY / DRY / WET）の3種類の中から表示する。
...
### 2.OLEDモニタのSSD1306のライブラリ活用
* **課題:** 
最初は、モニタの初期設定をいろいろなコードを参考にして、自分で作成しようとしました。しかし設定する項目が多く、またそれぞれが何を意味しているのか分からない部分が多く、そのままコピーするのは躊躇していました。<br>

* **解決策:** 
そこで、GitHubでSSD1306に対応したMIT Licenseのオープンソースライブラリを見つけ、導入することにしました。<br>
モニタの設定はライブラリに任せて、水やり装置本体の開発に専念することにしました。<br>

### 3. 電源系統の分離によるノイズ・電圧降下対策
