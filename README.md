...
* **課題:** 
最初は、SSD1306の初期設定をいろいろなコードを参考にして、自分で作ろうとしました。しかし、設定する項目が多く、それぞれが何を意味しているのか分からない部分が多く、そのままコピーアンドペーストをするようなことは躊躇していました。<br>

* **解決策:** 
そこで、GitHubでSSD1306に対応したMIT Licenseのオープンソースライブラリを見つけ、導入することにしました。<br>
ひとまずOLEDモニタの設定はライブラリに任せて、水やり装置本体の開発に専念しました。<br>
