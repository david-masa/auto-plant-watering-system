...
### 2.SSD1306のライブラリ活用
* **課題:** 
SSD1306の初期設定は、最初はサンプルコードを参考に自分で実装しようとしましたが、設定項目が多く、それぞれの意味を十分に理解できませんでした。<br>

* **解決策:** 
そこで、SSD1306対応のオープンソースライブラリを調べて導入しました。.hと.cファイルをプロジェクト内に配置し、メインコードからインクルードすることで、SSD1306の設定を数行で行えるようにしました。<br>
分からない部分を無理に一から作るのではなく、既存のライブラリを調べて活用することで、開発を進めることができました。<br>
